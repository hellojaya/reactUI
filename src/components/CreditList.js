		...
		return (
			<div className="credits">
				<div className="credits-title">
					{'Top Billed Cast'}
					{credits.length > 6 && (
						<span className={this.state.visibleAll ? 'active' : ''} onClick={this.showAll}>{'Show all'}</span>
					)}
				</div>
...
export default (withRouter(connect(mapStateToProps, mapDispatchToProps)(CreditList)));